...
// Função pega um número aleatório de 0 a 0.99 e multiplica pela quantidade de frases existentes no array, e insere no html;
function fraseDaSorte( ) {
	let frase = Math.floor(Math.random() * 60);
	document.getElementById("minha-frase").innerHTML = frases[frase];
}
